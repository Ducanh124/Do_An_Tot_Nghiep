          ...
          <form onSubmit={handleSubmit} className="register-area-form">
            ...
            <div className="form-group">
              ...
              <select
                ...
                disabled={!selectedCity} // Khóa nếu chưa chọn thành phố
                className="area-select"
              >
                {/* Tùy chọn rỗng cho phép người dùng KHÔNG chọn Quận/Huyện */}
            ...
            {/* Checkbox: Khu vực làm việc chính */}
